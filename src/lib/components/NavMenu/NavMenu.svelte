...
<div class="nav-menu">
	<nav class="container flex flex-row items-center text-sm">
		...
		<div class="flex-row flex-1 self-center h-full justify-end hidden md:flex">
			...
			{/each}
			<button
				class="bg-transparent text-1.5em border-none cursor-pointer hover:bg-[color:var(--main-hover)] text-[var(--secondary-text)] px-4"
